...
class UpdateUserDetailsControllers extends GetxController{
  ...
  Future<void> updateFullName()async{
    try{
      ...
      UNLoaders.successSnackBar(title: 'Success', message: 'Your name has been updated');
  ...
  Future<void> updateUsername() async {
    try {
      ...
      // Show Success Message
      UNLoaders.successSnackBar(title: 'Success', message: 'Your username has been updated');
  ...
  Future<void> updatePhoneNumber() async {
    try {
      ...
      // Show Success Message
      UNLoaders.successSnackBar(title: 'Success', message: 'Your phone number has been updated');
  ...
  Future<void> updateGender() async {
    try {
      ...
      // Show Success Message
      UNLoaders.successSnackBar(title: 'Success', message: 'Your gender has been updated');
  ...
  Future<void> updateDateOfBirth() async {
    try {
      ...
      // Show Success Message
      UNLoaders.successSnackBar(title: 'Success', message: 'Your date of birth has been updated');
  ...
  Future<void> updateAddress() async {
    try {
      ...
      // Show Success Message
      UNLoaders.successSnackBar(title: 'Success', message: 'Your address has been updated');
