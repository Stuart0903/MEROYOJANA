...
class UNLoginDivider extends StatelessWidget {
  const UNLoginDivider({super.key, required this.dividerText});

  final String dividerText;
  @override
  Widget build(BuildContext context) {
    final bool dark = UNHelperFunctions.isDarkMode(context);
    return Row(
